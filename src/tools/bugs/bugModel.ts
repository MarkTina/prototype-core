...
export const bugSourceSides: BugSourceSide[] = ['安卓侧', 'iOS 侧', '安卓+iOS', '后端', '硬件设计', '嵌入式', 'web 端']
export const bugOwnerRoles: BugOwnerRole[] = ['后端开发', 'iOS 开发', '安卓开发', '产品经理', '算法开发', '硬件嵌入式开发', 'UI设计', '前端开发']
