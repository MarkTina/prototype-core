...
import guideMarkdown from '../../AI-PROTOTYPE-GUIDE.md?raw'
...
async function copyGuide() {
  try {
    if (navigator.clipboard?.writeText) await navigator.clipboard.writeText(guideMarkdown)
    else fallbackCopy()
...
<template>
  <section class="prototype-help-page">
    ...
    <div class="prototype-help-document" aria-label="Prototype Core 操作手册 Markdown 原文">
      <pre>{{ guideMarkdown }}</pre>
    </div>
  </section>
</template>
